...
glt_ce_chunk_size = 1
glt_checkpoint_aux_offsets = True
glt_normalize_latents = True
glt_linear_extrapolation = False
...
if enable_glt:
    ...
    glt_config_kwargs = GLTConfig(
        ...
        checkpoint_aux_offsets=bool(glt_checkpoint_aux_offsets),
        normalize_latents=bool(glt_normalize_latents),
        linear_extrapolation=bool(glt_linear_extrapolation),
        random_ce_offset=bool(glt_random_ce_offset),
...
user_config["glt_checkpoint_aux_offsets"] = glt_config.checkpoint_aux_offsets if glt_config else glt_checkpoint_aux_offsets
user_config["glt_normalize_latents"] = glt_config.normalize_latents if glt_config else glt_normalize_latents
user_config["glt_linear_extrapolation"] = glt_config.linear_extrapolation if glt_config else glt_linear_extrapolation
user_config["glt_random_ce_offset"] = glt_config.random_ce_offset if glt_config else glt_random_ce_offset
